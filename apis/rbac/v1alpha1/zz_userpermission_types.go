...
// UserPermissionSpec defines the desired state of UserPermission
type UserPermissionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     UserPermissionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider UserPermissionInitParameters `json:"initProvider,omitempty"`
}

// UserPermissionStatus defines the observed state of UserPermission.
type UserPermissionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        UserPermissionObservation `json:"atProvider,omitempty"`
}
...
// UserPermission is the Schema for the UserPermissions API.
...
type UserPermission struct {
	...
	Spec   UserPermissionSpec   `json:"spec"`
	Status UserPermissionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// UserPermissionList contains a list of UserPermissions
...
var (
	UserPermission_Kind             = "UserPermission"
	UserPermission_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: UserPermission_Kind}.String()
	UserPermission_KindAPIVersion   = UserPermission_Kind + "." + CRDGroupVersion.String()
	UserPermission_GroupVersionKind = CRDGroupVersion.WithKind(UserPermission_Kind)
)

func init() {
	SchemeBuilder.Register(&UserPermission{}, &UserPermissionList{})
}
