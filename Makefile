...
kcl:
	...
	cd kcl/crossplane_authentik/v1alpha1 && bash -c 'for f in ls *.k  ; do if [[ $f != authentik* ]] ; then prefix="$(echo $f | cut -d'_' -f1)"; echo $prefix && mkdir -p ../$prefix/v1alpha1 && mv $f ../$prefix/v1alpha1/  ; fi  ; done'
